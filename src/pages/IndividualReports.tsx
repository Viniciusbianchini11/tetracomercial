...
import { DollarSign, TrendingUp, Target, CalendarIcon, Clock, UserSearch } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto p-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold">Relatórios Individuais</h1>
          <p className="text-muted-foreground mt-2">
            Selecione um vendedor para visualizar seu desempenho
          </p>
        </div>
        ...
        {!selectedSeller ? (
          <Card className="p-12">
            <div className="text-center text-muted-foreground">
              ...
              <p className="text-lg">Selecione um vendedor acima para visualizar os dados</p>
            </div>
          </Card>
        ) : (
          <>
